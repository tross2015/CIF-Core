...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 89000; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        ...
        nDefaultPort = 43199;
        nMaxTipAge = 3 * 24 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
        nDelayGetHeadersTime = 3 * 24 * 60 * 60;
