...
public:
    CMainParams() {
        ...
        //TODO: Need to update this on MAIN NET
        consensus.nMasternodePaymentsStartBlock = 90000; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        ...
        //TODO: This need to be removed on MAIN NET
        ...
        consensus.nPowTargetTimespan = 10 * 24 * 60 * 60; // Cif: 10 days
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000d3c03cc1c305c4dd"); // 782700
        ...
        nDefaultPort = 43199;
        nMaxTipAge = 2 * 24 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
        nDelayGetHeadersTime = 2 * 24 * 60 * 60;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Cif: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Cif: 2.5 minutes
        ...
        // Testnet Cif addresses start with 'i'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,102);
        // Testnet Cif script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Cif BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cif BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0xf905ffc113735452ae0513d431cb9c6f97f55dc1c333bb59ee5d2e1991e3cece")),
...
//        assert(genesis.hashMerkleRoot == uint256S("0x1a1469ab25b242ece1c1eea5301d6c90376b1d612242a720a25862c966057303"));
        ...
        // Regtest Cif addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Cif script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Cif BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Cif BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Cif BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
