...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CIF Core cif-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cif-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CIF transaction") + "\n" +
              "  cif-tx [options] -create [commands]   " + _("Create hex-encoded CIF transaction") + "\n" +
              "\n";
