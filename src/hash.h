...

{
    ...
    printf("After sph_blake_512: %s", hash[0].trim256().ToString().c_str());

    sph_bmw512_init(&ctx_bmw);
    sph_bmw512 (&ctx_bmw, static_cast<const void*>(&hash[0]), 64);
    sph_bmw512_close(&ctx_bmw, static_cast<void*>(&hash[1]));

    printf("After sph_bmw512: %s", hash[1].trim256().ToString().c_str());

    sph_groestl512_init(&ctx_groestl);
    sph_groestl512 (&ctx_groestl, static_cast<const void*>(&hash[1]), 64);
    sph_groestl512_close(&ctx_groestl, static_cast<void*>(&hash[2]));

    printf("After sph_groestl512: %s", hash[2].trim256().ToString().c_str());

    sph_skein512_init(&ctx_skein);
    sph_skein512 (&ctx_skein, static_cast<const void*>(&hash[2]), 64);
    sph_skein512_close(&ctx_skein, static_cast<void*>(&hash[3]));

    printf("After sph_skein512: %s", hash[3].trim256().ToString().c_str());

    sph_jh512_init(&ctx_jh);
    sph_jh512 (&ctx_jh, static_cast<const void*>(&hash[3]), 64);
    sph_jh512_close(&ctx_jh, static_cast<void*>(&hash[4]));

    printf("After sph_jh512: %s", hash[4].trim256().ToString().c_str());

    sph_keccak512_init(&ctx_keccak);
    sph_keccak512 (&ctx_keccak, static_cast<const void*>(&hash[4]), 64);
    sph_keccak512_close(&ctx_keccak, static_cast<void*>(&hash[5]));

    printf("After sph_keccak512: %s", hash[5].trim256().ToString().c_str());

    sph_luffa512_init(&ctx_luffa);
    sph_luffa512 (&ctx_luffa, static_cast<void*>(&hash[5]), 64);
    sph_luffa512_close(&ctx_luffa, static_cast<void*>(&hash[6]));

    printf("After sph_luffa512: %s", hash[6].trim256().ToString().c_str());
    ...
    printf("After sph_cubehash512: %s", hash[7].trim256().ToString().c_str());
    ...
    printf("After sph_shavite512: %s", hash[8].trim256().ToString().c_str());

    sph_simd512_init(&ctx_simd);
    sph_simd512 (&ctx_simd, static_cast<const void*>(&hash[8]), 64);
    sph_simd512_close(&ctx_simd, static_cast<void*>(&hash[9]));

    printf("After sph_simd512: %s", hash[9].trim256().ToString().c_str());

    sph_echo512_init(&ctx_echo);
    sph_echo512 (&ctx_echo, static_cast<const void*>(&hash[9]), 64);
    sph_echo512_close(&ctx_echo, static_cast<void*>(&hash[10]));

    printf("After sph_echo512: %s", hash[10].trim256().ToString().c_str());
