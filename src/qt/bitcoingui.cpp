    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CIF Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CIF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CIF: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CIF Core"), this);
    aboutAction->setStatusTip(tr("Show information about CIF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CIF Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CIF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CIF addresses"));
    ...
    openAction->setStatusTip(tr("Open a CIF: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CIF Core help message to get a list with possible CIF Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CIF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CIF network", "", count));
    } else {
...
{
    QString strTitle = tr("CIF Core"); // default title
