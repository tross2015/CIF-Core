    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CIF Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CIF Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cif-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CIF in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CIF, 0.1 CIF, 1 CIF and 10 CIF -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CIF Core is shutting down...") + "<br /><br />" +
