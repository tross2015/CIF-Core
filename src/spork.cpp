...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_REQUIRE_POW_FLAG:                 r = SPORK_15_REQUIRE_POW_FLAG_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_REQUIRE_POW_FLAG:                 return SPORK_15_REQUIRE_POW_FLAG_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_REQUIRE_POW_FLAG")                 return SPORK_15_REQUIRE_POW_FLAG;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_REQUIRE_POW_FLAG:                 return "SPORK_15_REQUIRE_POW_FLAG";
        default:
